...
## [0.2.3] - 2026-01-08
### Added
-   **WatchlistModule**: Full CRUD for user watchlist with auction embedding.
-   **Settings API**: Endpoints for retrieving and updating user preferences (notifications, language).
-   **User Model**: Added JSONB field `settings` for extensible user configuration.
