...
export class AppService {
  ...
  getStats() {
    return this.apiClient.call("GET", "/admin/stats");
  }
  getExtendedStats() {
    return this.apiClient.call("GET", "/admin/dashboard/extended-stats");
  }
  getRevenueByDay(days = 90) {
    return this.apiClient.call(
      "GET",
      `/admin/dashboard/revenue-by-day?days=${days}`,
    );
  }
  getNewUsersByDay(days = 30) {
    return this.apiClient.call(
      "GET",
      `/admin/dashboard/users-by-day?days=${days}`,
    );
  }
  ...
  getUser(id: string) {
    return this.apiClient.call("GET", `/admin/users/${id}`);
  }
  ...
  getLot(id: string) {
    return this.apiClient.call("GET", `/admin/lots/${id}`);
  }
  blockLot(id: string, adminUser: string) {
    return this.apiClient.call("PATCH", `/admin/lots/${id}/block`, {
      adminUser,
    });
  }
  unblockLot(id: string, adminUser: string) {
    return this.apiClient.call("PATCH", `/admin/lots/${id}/unblock`, {
      adminUser,
    });
  }
  updateLot(id: string, data: Record<string, unknown>) {
    return this.apiClient.call("PATCH", `/admin/lots/${id}`, data);
  }
  ...
  getCommissionsConfig() {
    return this.apiClient.call("GET", "/admin/financial/commissions/config");
  }
  getCommissionsRecords(page = 1, status?: string) {
    ...
    return this.apiClient.call(
      "GET",
      `/admin/financial/commissions/records?${qs}`,
    );
  }
  upsertGlobalRate(ratePercent: number, adminUser: string) {
    return this.apiClient.call(
      "PUT",
      "/admin/financial/commissions/config/global",
      { ratePercent, adminUser },
    );
  }
  upsertSellerRate(sellerId: string, ratePercent: number, adminUser: string) {
    return this.apiClient.call(
      "PUT",
      `/admin/financial/commissions/config/seller/${sellerId}`,
      { ratePercent, adminUser },
    );
  }
  deleteCommissionConfig(id: string) {
    return this.apiClient.call(
      "DELETE",
      `/admin/financial/commissions/config/${id}`,
    );
  }
  markCommissionCollected(id: string) {
    return this.apiClient.call(
      "PATCH",
      `/admin/financial/commissions/records/${id}/mark-collected`,
    );
  }
  ...
  createRefund(orderId: string, amount: number, reason: string) {
    return this.apiClient.call("POST", "/admin/refunds", {
      orderId,
      amount,
      reason,
    });
  ...
  updateRefundStatus(id: string, status: string) {
    return this.apiClient.call("PATCH", `/admin/refunds/${id}/status`, {
      status,
    });
  }
  ...
  getReconciliation(provider: string, dateFrom: string, dateTo: string) {
    return this.apiClient.call(
      "GET",
      `/admin/reconciliation?provider=${provider}&dateFrom=${dateFrom}&dateTo=${dateTo}`,
    );
  }
  ...
  getAllSeoConfigs() {
    return this.apiClient.call("GET", "/admin/seo");
  }
  ...
  getAllCmsContent() {
    return this.apiClient.call("GET", "/admin/cms");
  }
  updateCmsContent(
    key: string,
    value: string,
    ...
    return this.apiClient.call("PUT", `/admin/cms/${key}`, {
      value,
      ...metadata,
    });
  }
  ...
  getDisputes(page = 1) {
    return this.apiClient.call("GET", `/admin/disputes?page=${page}`);
  }
  getDisputeDetail(id: string) {
    return this.apiClient.call("GET", `/admin/disputes/${id}`);
  }
  resolveDisputeBuyer(id: string, reason: string, adminUser: string) {
    return this.apiClient.call("POST", `/admin/disputes/${id}/resolve-buyer`, {
      reason,
      adminUser,
    });
  }
  resolveDisputeSeller(id: string, reason: string, adminUser: string) {
    return this.apiClient.call("POST", `/admin/disputes/${id}/resolve-seller`, {
      reason,
      adminUser,
    });
  }
  ...
  approveModeration(id: string, adminUser: string) {
    return this.apiClient.call("PATCH", `/admin/moderation/${id}/approve`, {
      adminUser,
    });
  }
  rejectModeration(
    ...
    return this.apiClient.call("PATCH", `/admin/moderation/${id}/reject`, {
      reason_code,
      notes,
      adminUser,
    });
  ...
  getCampaigns(page = 1) {
    return this.apiClient.call(
      "GET",
      `/admin/notifications/campaigns?page=${page}`,
    );
  }
  sendCampaign(body: {
    segment: string;
