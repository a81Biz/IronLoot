...
describe("Money", () => {
  ...
  describe("greaterThanOrEqual", () => {
    it("should return true when greater", () => {
      expect(
        new Money(200, "MXN").greaterThanOrEqual(new Money(100, "MXN")),
      ).toBe(true);
    });

    it("should return true when equal", () => {
      expect(
        new Money(100, "MXN").greaterThanOrEqual(new Money(100, "MXN")),
      ).toBe(true);
    });

    it("should return false when less", () => {
      expect(
        new Money(50, "MXN").greaterThanOrEqual(new Money(100, "MXN")),
      ).toBe(false);
    });
  ...
  describe("greaterThan", () => {
    it("should return true when strictly greater", () => {
      expect(new Money(200, "MXN").greaterThan(new Money(100, "MXN"))).toBe(
        true,
      );
    });

    it("should return false when equal", () => {
      expect(new Money(100, "MXN").greaterThan(new Money(100, "MXN"))).toBe(
        false,
      );
    });

    it("should return false when less", () => {
      expect(new Money(50, "MXN").greaterThan(new Money(100, "MXN"))).toBe(
        false,
      );
    });
  });
