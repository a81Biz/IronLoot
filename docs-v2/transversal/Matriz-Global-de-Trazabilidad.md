...
| RN-17 soft-close | UC-06 | Auction | `bids.service.ts:100` | (WS `auction:extended`) | ✅ | scheduler 3 | Comprador | ✅ | AUD-002 corregido · AUD-006 sin verificar |
...
| RN-27 moneda MXN | — | Payment,Wallet | `schema.prisma` | N/A | N/A | core Money 30 (**sigue sin usarse**) | — | ✅ | AUD-008 corregido · **AUD-012 abierto** |
